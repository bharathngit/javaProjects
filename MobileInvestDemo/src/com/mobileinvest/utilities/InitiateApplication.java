...
public class InitiateApplication {
		...
		public static AndroidDriver driver;
			...
			capabilities.setCapability("deviceName", "HTC One_m8"); //Replace "HTC Once_m8" with your Device Name
			capabilities.setCapability("platformVersion", "6.0"); //Replace "6.0" with your Device's Android Version
